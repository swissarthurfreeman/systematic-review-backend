...
to launch this application as a standalone, it is provided here for showcase purposes only.

### Next section

The next section describes the inner workings of the backend microservice. It describes the domain
using UML and the REST api specification.
